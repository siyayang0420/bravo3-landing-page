...
export default function Pay() {
  return (
    <section className="section-screen pay" id="get">
      ...
      <div className="pay__inner">
        <div className="pay__copy">
          <h2 className="display section-title pay__title">Every Meal Gives Something Back</h2>
          <p className="section-lede pay__lede">Scan, pay, and keep the night going. Rewards happen automatically in the background.</p>
